...
from generatepesel import GeneratePesel, GenderNotValid
...
class TestClass:
    ...
    def test_get_year_to_generate_correct(self):
        ...
        result = GeneratePesel()._get_year_to_generate_pesel(dob)
        assert result == "1992"
    ...
    def test_gender_value_woman(self):
        gender = "K"
        result = GeneratePesel()._get_gender_value(gender)
        assert result % 2 == 0
    ...
    def test_gender_value_wrong_type(self):
        with pytest.raises(GenderNotValid) as e:
            gender_value = 3
            result = GeneratePesel()._get_gender_value(gender_value)
            assert e
    ...
    def test_join_pesel_elements_correct(self):
        ...
        gender = "K"
        result = GeneratePesel()._join_pesel_elements(dob, gender)
        assert result
    ...
    def test_make_control_sum_correct(self):
        ...
        gender = "K"
        result = GeneratePesel()._make_control_sum(dob, gender)
        assert result
    ...
    def test_get_control_digit_correct(self):
        dob = datetime.datetime(1932, 12, 3)
        gender = "K"
        result = GeneratePesel()._get_control_digit(dob, gender)
        assert 0 <= result <= 9
    ...
    def test_join_control_digit_to_pesel_correct(self):
        ...
        gender = "M"
        result = GeneratePesel()._join_control_digit_to_pesel(dob, gender)
        assert result
    ...
    def test_generate_correct(self):
        dob = datetime.datetime(1932, 12, 3)
        gender = "M"
        result = GeneratePesel().generate(dob, gender)
        assert result
